...
import { customSolarTime, registerSolarTimes } from "./solar-times.ts";
...
function extractSolarDayTimes(
  ...
  return {
    ...
    blueHourEnd: validDate(customSolarTime(times, "blueHourEnd")),
    blueHour: validDate(customSolarTime(times, "blueHour")),
  };
}
