...
export function ViewSwitcher({
  ...
  return (
    <div
      className={`pointer-events-auto fixed top-[calc(0.75rem+env(safe-area-inset-top,0px))] right-3 z-50 flex items-center gap-1.5 md:right-4 lg:right-5 ${className}`}
    >
      <button
        type="button"
